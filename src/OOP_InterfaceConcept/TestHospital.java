...
public class TestHospital {
	...
	public static void main(String[] args) {
		...
		fh.medicalPolicy();
		// Java will not allow to create interface object creation - Because interface
		// will have only method body(i.e abstract)
		 ...
		 */
		/*
		 * Selenium WebDriver a = new ChromeDriver();
		 */
		...
		// us.medicalTraining(); - Individual method of FortisHospital will be failed by
